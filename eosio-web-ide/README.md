...
2. Point your browser to the following URL https://gitpod.io/#https://github.com/poladmahmudov/eosio-web-ide to start the IDE. You will be automatically prompted to create a Gitpod account (all types of Gitpod accounts (including free) will work). You can also choose to provide multiple developers push access to your personal github fork of this repo to collaborate with them (one developer working on the smart contract (C++) while the other working on the front-end decentralized application (EOSJS), etc.). Each such developer sharing access to the forked repo will get their own copy of the EOSIO blockchain components to enable independent development.
...
```
eosio-cpp ./integrity.cpp

```

This will produce `integrity.abi` and `integrity.wasm`.

For reliability

```
eosio-cpp ./reliability.cpp

```

This will produce `reliability.abi` and `reliability.wasm`.
...
For integrity from contract dir

```
cleos create account eosio integrity EOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
cleos set contract integrity ./integrity -p integrity@active
```

For reliability from contract dir

```
cleos create account eosio reliability EOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
cleos set contract reliability ./reliability -p reliability@active
```
...
Run this for integirty contract
```
cleos create account eosio lili EOS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV
cleos push action integrity publish '["7af12386a82b6337d6b1e4c6a1119e29bb03e6209aa03c70ed3efbb9b74a290c", "lili", "https://google.com", "https://github.com"]' -p lili@active

```

Run this for integirty contract
```
cleos push action reliability publish '["7af12386a82b6337d6b1e4c6a1119e29bb03e6209aa03c70ed3efbb9b74a290c", "bob", "https://google.com", "Basic checks were done. No vulnerabilities were found.", true]' -p bob@active
```
...
For integrity contract.
Explenation [here](https://eosio.stackexchange.com/questions/4116/how-to-use-checksum256-secondary-index-to-get-table-rows).

```
cleos get table integrity '' resources --lower "299e11a1c6e4b1d637632ba88623f17a0c294ab7b9fb3eed703ca09a20e603bb" --upper "299e11a1c6e4b1d637632ba88623f17a0c294ab7b9fb3eed703ca09a20e603bb"  --key-type "sha256" --index "2"
```

For reliability contract
```
cleos get table reliability '' reports --lower "299e11a1c6e4b1d637632ba88623f17a0c294ab7b9fb3eed703ca09a20e603bb" --upper "299e11a1c6e4b1d637632ba88623f17a0c294ab7b9fb3eed703ca09a20e603bb"  --key-type "sha256" --index "2"
```
